...
from smart_media import __version__ as smart_media_version


# -- Project information -----------------------------------------------------

now = datetime.date.today()
project = "django-smart-media"
copyright = "2022-{}, David Thenon".format(now.year)
author = "David Thenon"

# The short X.Y version
version = smart_media_version
# The full version, including alpha/beta/rc tags
release = smart_media_version
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/sveetch/django-smart-media/",
