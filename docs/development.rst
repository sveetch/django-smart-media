...
django-smart-media is developed with:
...
type: ::
    ...
    git clone https://github.com/sveetch/django-smart-media.git
    cd django-smart-media
    make install

django-smart-media will be installed in editable mode from the
